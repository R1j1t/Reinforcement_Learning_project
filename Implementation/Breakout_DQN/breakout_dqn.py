...
class DQN:
    ...
    def init_model(self, load = False, path = "model.h5"):
        ...
        # hidden layers 
        self.model.add(Conv2D(16, kernel_size = (8, 8), strides = (4, 4), input_shape = (80, 80, 4)))   
        ...
        self.model.compile(Adam(self.learning_rate), loss='mean_squared_error')    # compile model 
